...
/*
•	Input: pdeYYYY.dta (06-14)
•	Output: XXXXX_dYYYY.dta (06-14)
•	Pulls drugs of interest from 06-14, by gname.
...
gen oxybu = 1 if strpos(gname, "OXYBUTYNIN")
...
//drop weird forms
drop if gcdf_desc=="POWDER (GM)" | gcdf_desc=="SYRUP"
drop if gcdf_desc=="GEL IN PACKET (GRAM)" 
drop if gcdf_desc=="GEL IN METERED-DOSE PUMP" 
...
///////////////// Array
forvalues d = 1/365{
	gen oxybu_a`d' = 1 if `d'>=doy_srvc & `d'<=(doy_srvc+dayssply2) & oxybu==1
}
...
/////////////////bene-class timing
egen oxybu_fdays_2006 = sum(dayssply), by(idn)
egen oxybu_clms_2006 = count(dayssply), by(idn)
egen oxybu_minfilldt_2006 = min(srvc_dt), by(idn)
egen oxybu_maxfilldt_2006 = max(srvc_dt), by(idn)
gen oxybu_fillperiod_2006 = oxybu_maxfilldt_2006 - oxybu_minfilldt_2006 + 1
...
replace claim_mgs = 15*qtydspns if str=="15MG"
replace claim_mgs = 15*qtydspns if str=="15 MG"
replace claim_mgs = 5*qtydspns if str=="3.9MG/24HR"
//sum mgs for all claims in year by bene
egen itot_mgs = sum(claim_mgs), by(idn)
//average mgs per day supplied
gen oxybu_dmg_2006 = itot_mgs/oxybu_fdays_2006
...
forvalues d = 1/365{
	replace snf_push = snf_push + 1 if oxybu_a`d'==1 & snf_a`d'==1

	//if the oxybu_a`d' is 1, do nothing (already added it to the snf_push)
	//if that oxybu_a spot is empty:
	gen v1 = 1 if snf_push>0 & oxybu_a`d'==.
	replace oxybu_a`d' = 1 if v1==1
...
forvalues d = 1/365{
	replace ips_push = ips_push + 1 if oxybu_a`d'==1 & ips_a`d'==1

	//if the oxybu_a`d' is 1, do nothing (already added it to the ips_push)
	//if that oxybu_a spot is not full:
	gen v1 = 1 if ips_push>0 & oxybu_a`d'==.
	replace oxybu_a`d' = 1 if v1==1
...
*/
forvalues d = 1/365{
	replace oxybu_pdays_2006 = oxybu_pdays_2006 + 1 if oxybu_a`d'==1
}
drop oxybu_a*
replace oxybu_pdays_2006 = 365 if oxybu_pdays_2006>365

//	mgs in year, for all the possession days
gen oxybu_totmg_2006 = oxybu_pdays_2006*oxybu_dmg_2006
//	total daily doses in the year
gen oxybu_totdd_2006 = oxybu_totmg_2006/5
...
egen oxybu_push_2006 = rowmax(lastfill_push inyear_push) 
replace oxybu_push_2006 = 0 if oxybu_push_2006==.
replace oxybu_push_2006 = 0 if oxybu_push_2006<0
...
replace pushstock = pushstock + oxybu_push_2006 if bene_id!=bene_id[_n-1] | _n==1
...
/////////////////bene-class timing
egen oxybu_fdays_2007 = sum(dayssply), by(idn)
egen oxybu_clms_2007 = count(dayssply), by(idn)
egen oxybu_minfilldt_2007 = min(srvc_dt), by(idn)
egen oxybu_maxfilldt_2007 = max(srvc_dt), by(idn)
gen oxybu_fillperiod_2007 = oxybu_maxfilldt_2007 - oxybu_minfilldt_2007 + 1
...
egen itot_mgs = sum(claim_mgs), by(idn)
//average mgs per day supplied
gen oxybu_dmg_2007 = itot_mgs/oxybu_fdays_2007
drop claim_mgs itot_mgs
...
*/
forvalues d = 1/365{
	replace oxybu_pdays_2007 = oxybu_pdays_2007 + 1 if oxybu_a`d'==1
}
drop oxybu_a*
replace oxybu_pdays_2007 = 365 if oxybu_pdays_2007>365

//	mgs in year, for all the possession days
gen oxybu_totmg_2007 = oxybu_pdays_2007*oxybu_dmg_2007
//	total daily doses in the year
gen oxybu_totdd_2007 = oxybu_totmg_2007/5
...
gen inyear_push = earlyfill_push + snf_push + ips_push
replace inyear_push = 30 if inyear_push>30 & inyear_push!=.
egen oxybu_push_2007 = rowmax(lastfill_push inyear_push) 
replace oxybu_push_2007 = 0 if oxybu_push_2007==.
replace oxybu_push_2007 = 0 if oxybu_push_2007<0
...
//add the pushstock from last year
replace pushstock = pushstock + oxybu_push_2007 if bene_id!=bene_id[_n-1] | _n==1
...
/////////////////bene-class timing
egen oxybu_fdays_2008 = sum(dayssply), by(idn)
egen oxybu_clms_2008 = count(dayssply), by(idn)
egen oxybu_minfilldt_2008 = min(srvc_dt), by(idn)
egen oxybu_maxfilldt_2008 = max(srvc_dt), by(idn)
gen oxybu_fillperiod_2008 = oxybu_maxfilldt_2008 - oxybu_minfilldt_2008 + 1
...
egen itot_mgs = sum(claim_mgs), by(idn)
//average mgs per day supplied
gen oxybu_dmg_2008 = itot_mgs/oxybu_fdays_2008
drop claim_mgs itot_mgs
...
*/
forvalues d = 1/365{
	replace oxybu_pdays_2008 = oxybu_pdays_2008 + 1 if oxybu_a`d'==1
}
drop oxybu_a*
replace oxybu_pdays_2008 = 365 if oxybu_pdays_2008>365

//	mgs in year, for all the possession days
gen oxybu_totmg_2008 = oxybu_pdays_2008*oxybu_dmg_2008
//	total daily doses in the year
gen oxybu_totdd_2008 = oxybu_totmg_2008/5
...
gen inyear_push = earlyfill_push + snf_push + ips_push
replace inyear_push = 30 if inyear_push>30 & inyear_push!=.
egen oxybu_push_2008 = rowmax(lastfill_push inyear_push) 
replace oxybu_push_2008 = 0 if oxybu_push_2008==.
replace oxybu_push_2008 = 0 if oxybu_push_2008<0
...
//add the pushstock from last year
replace pushstock = pushstock + oxybu_push_2008 if bene_id!=bene_id[_n-1] | _n==1
...
/////////////////bene-class timing
egen oxybu_fdays_2009 = sum(dayssply), by(idn)
egen oxybu_clms_2009 = count(dayssply), by(idn)
egen oxybu_minfilldt_2009 = min(srvc_dt), by(idn)
egen oxybu_maxfilldt_2009 = max(srvc_dt), by(idn)
gen oxybu_fillperiod_2009 = oxybu_maxfilldt_2009 - oxybu_minfilldt_2009 + 1
...
egen itot_mgs = sum(claim_mgs), by(idn)
//average mgs per day supplied
gen oxybu_dmg_2009 = itot_mgs/oxybu_fdays_2009
drop claim_mgs itot_mgs
...
*/
forvalues d = 1/365{
	replace oxybu_pdays_2009 = oxybu_pdays_2009 + 1 if oxybu_a`d'==1
}
drop oxybu_a*
replace oxybu_pdays_2009 = 365 if oxybu_pdays_2009>365

//	mgs in year, for all the possession days
gen oxybu_totmg_2009 = oxybu_pdays_2009*oxybu_dmg_2009
//	total daily doses in the year
gen oxybu_totdd_2009 = oxybu_totmg_2009/5
...
gen inyear_push = earlyfill_push + snf_push + ips_push
replace inyear_push = 30 if inyear_push>30 & inyear_push!=.
egen oxybu_push_2009 = rowmax(lastfill_push inyear_push) 
replace oxybu_push_2009 = 0 if oxybu_push_2009==.
replace oxybu_push_2009 = 0 if oxybu_push_2009<0
...
//add the pushstock from last year
replace pushstock = pushstock + oxybu_push_2009 if bene_id!=bene_id[_n-1] | _n==1
...
/////////////////bene-class timing
egen oxybu_fdays_2010 = sum(dayssply), by(idn)
egen oxybu_clms_2010 = count(dayssply), by(idn)
egen oxybu_minfilldt_2010 = min(srvc_dt), by(idn)
egen oxybu_maxfilldt_2010 = max(srvc_dt), by(idn)
gen oxybu_fillperiod_2010 = oxybu_maxfilldt_2010 - oxybu_minfilldt_2010 + 1
...
egen itot_mgs = sum(claim_mgs), by(idn)
//average mgs per day supplied
gen oxybu_dmg_2010 = itot_mgs/oxybu_fdays_2010
drop claim_mgs itot_mgs
...
*/
forvalues d = 1/365{
	replace oxybu_pdays_2010 = oxybu_pdays_2010 + 1 if oxybu_a`d'==1
}
drop oxybu_a*
replace oxybu_pdays_2010 = 365 if oxybu_pdays_2010>365

//	mgs in year, for all the possession days
gen oxybu_totmg_2010 = oxybu_pdays_2010*oxybu_dmg_2010
//	total daily doses in the year
gen oxybu_totdd_2010 = oxybu_totmg_2010/5
...
gen inyear_push = earlyfill_push + snf_push + ips_push
replace inyear_push = 30 if inyear_push>30 & inyear_push!=.
egen oxybu_push_2010 = rowmax(lastfill_push inyear_push) 
replace oxybu_push_2010 = 0 if oxybu_push_2010==.
replace oxybu_push_2010 = 0 if oxybu_push_2010<0
...
//add the pushstock from last year
replace pushstock = pushstock + oxybu_push_2010 if bene_id!=bene_id[_n-1] | _n==1
...
/////////////////bene-class timing
egen oxybu_fdays_2011 = sum(dayssply), by(idn)
egen oxybu_clms_2011 = count(dayssply), by(idn)
egen oxybu_minfilldt_2011 = min(srvc_dt), by(idn)
egen oxybu_maxfilldt_2011 = max(srvc_dt), by(idn)
gen oxybu_fillperiod_2011 = oxybu_maxfilldt_2011 - oxybu_minfilldt_2011 + 1
...
egen itot_mgs = sum(claim_mgs), by(idn)
//average mgs per day supplied
gen oxybu_dmg_2011 = itot_mgs/oxybu_fdays_2011
drop claim_mgs itot_mgs
...
*/
forvalues d = 1/365{
	replace oxybu_pdays_2011 = oxybu_pdays_2011 + 1 if oxybu_a`d'==1
}
drop oxybu_a*
replace oxybu_pdays_2011 = 365 if oxybu_pdays_2011>365

//	mgs in year, for all the possession days
gen oxybu_totmg_2011 = oxybu_pdays_2011*oxybu_dmg_2011
//	total daily doses in the year
gen oxybu_totdd_2011 = oxybu_totmg_2011/5
...
gen inyear_push = earlyfill_push + snf_push + ips_push
replace inyear_push = 30 if inyear_push>30 & inyear_push!=.
egen oxybu_push_2011 = rowmax(lastfill_push inyear_push) 
replace oxybu_push_2011 = 0 if oxybu_push_2011==.
replace oxybu_push_2011 = 0 if oxybu_push_2011<0
...
//add the pushstock from last year
replace pushstock = pushstock + oxybu_push_2011 if bene_id!=bene_id[_n-1] | _n==1
...
/////////////////bene-class timing
egen oxybu_fdays_2012 = sum(dayssply), by(idn)
egen oxybu_clms_2012 = count(dayssply), by(idn)
egen oxybu_minfilldt_2012 = min(srvc_dt), by(idn)
egen oxybu_maxfilldt_2012 = max(srvc_dt), by(idn)
gen oxybu_fillperiod_2012 = oxybu_maxfilldt_2012 - oxybu_minfilldt_2012 + 1
...
egen itot_mgs = sum(claim_mgs), by(idn)
//average mgs per day supplied
gen oxybu_dmg_2012 = itot_mgs/oxybu_fdays_2012
drop claim_mgs itot_mgs
...
*/
forvalues d = 1/365{
	replace oxybu_pdays_2012 = oxybu_pdays_2012 + 1 if oxybu_a`d'==1
}
drop oxybu_a*
replace oxybu_pdays_2012 = 365 if oxybu_pdays_2012>365

//	mgs in year, for all the possession days
gen oxybu_totmg_2012 = oxybu_pdays_2012*oxybu_dmg_2012
//	total daily doses in the year
gen oxybu_totdd_2012 = oxybu_totmg_2012/5
...
gen inyear_push = earlyfill_push + snf_push + ips_push
replace inyear_push = 30 if inyear_push>30 & inyear_push!=.
egen oxybu_push_2012 = rowmax(lastfill_push inyear_push) 
replace oxybu_push_2012 = 0 if oxybu_push_2012==.
replace oxybu_push_2012 = 0 if oxybu_push_2012<0
...
//add the pushstock from last year
replace pushstock = pushstock + oxybu_push_2012 if bene_id!=bene_id[_n-1] | _n==1
...
/////////////////bene-class timing
egen oxybu_fdays_2013 = sum(dayssply), by(idn)
egen oxybu_clms_2013 = count(dayssply), by(idn)
egen oxybu_minfilldt_2013 = min(srvc_dt), by(idn)
egen oxybu_maxfilldt_2013 = max(srvc_dt), by(idn)
gen oxybu_fillperiod_2013 = oxybu_maxfilldt_2013 - oxybu_minfilldt_2013 + 1
...
egen itot_mgs = sum(claim_mgs), by(idn)
//average mgs per day supplied
gen oxybu_dmg_2013 = itot_mgs/oxybu_fdays_2013
drop claim_mgs itot_mgs
...
*/
forvalues d = 1/365{
	replace oxybu_pdays_2013 = oxybu_pdays_2013 + 1 if oxybu_a`d'==1
}
drop oxybu_a*
replace oxybu_pdays_2013 = 365 if oxybu_pdays_2013>365

//	mgs in year, for all the possession days
gen oxybu_totmg_2013 = oxybu_pdays_2013*oxybu_dmg_2013
//	total daily doses in the year
gen oxybu_totdd_2013 = oxybu_totmg_2013/5
...
gen inyear_push = earlyfill_push + snf_push + ips_push
replace inyear_push = 30 if inyear_push>30 & inyear_push!=.
egen oxybu_push_2013 = rowmax(lastfill_push inyear_push) 
replace oxybu_push_2013 = 0 if oxybu_push_2013==.
replace oxybu_push_2013 = 0 if oxybu_push_2013<0
...
//add the pushstock from last year
replace pushstock = pushstock + oxybu_push_2013 if bene_id!=bene_id[_n-1] | _n==1
...
/////////////////bene-class timing
egen oxybu_fdays_2014 = sum(dayssply), by(idn)
egen oxybu_clms_2014 = count(dayssply), by(idn)
egen oxybu_minfilldt_2014 = min(srvc_dt), by(idn)
egen oxybu_maxfilldt_2014 = max(srvc_dt), by(idn)
gen oxybu_fillperiod_2014 = oxybu_maxfilldt_2014 - oxybu_minfilldt_2014 + 1
...
egen itot_mgs = sum(claim_mgs), by(idn)
//average mgs per day supplied
gen oxybu_dmg_2014 = itot_mgs/oxybu_fdays_2014
drop claim_mgs itot_mgs
...
*/
forvalues d = 1/365{
	replace oxybu_pdays_2014 = oxybu_pdays_2014 + 1 if oxybu_a`d'==1
}
drop oxybu_a*
replace oxybu_pdays_2014 = 365 if oxybu_pdays_2014>365

//	mgs in year, for all the possession days
gen oxybu_totmg_2014 = oxybu_pdays_2014*oxybu_dmg_2014
//	total daily doses in the year
gen oxybu_totdd_2014 = oxybu_totmg_2014/5
...
gen inyear_push = earlyfill_push + snf_push + ips_push
replace inyear_push = 30 if inyear_push>30 & inyear_push!=.
egen oxybu_push_2014 = rowmax(lastfill_push inyear_push) 
replace oxybu_push_2014 = 0 if oxybu_push_2014==.
replace oxybu_push_2014 = 0 if oxybu_push_2014<0
