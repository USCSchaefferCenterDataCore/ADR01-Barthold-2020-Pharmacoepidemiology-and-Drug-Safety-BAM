...
gen tolte = 1 if strpos(gname, "TOLTERODINE")
...
///////////////// Array
forvalues d = 1/365{
	gen tolte_a`d' = 1 if `d'>=doy_srvc & `d'<=(doy_srvc+dayssply2) & tolte==1
}
...
/////////////////bene-class timing
egen tolte_fdays_2006 = sum(dayssply), by(idn)
egen tolte_clms_2006 = count(dayssply), by(idn)
egen tolte_minfilldt_2006 = min(srvc_dt), by(idn)
egen tolte_maxfilldt_2006 = max(srvc_dt), by(idn)
gen tolte_fillperiod_2006 = tolte_maxfilldt_2006 - tolte_minfilldt_2006 + 1

//////////////// weighted average dose
//claim_mgs is calculated dependent on dose form (at the claim level). 
gen claim_mgs = 0
replace claim_mgs = 1*qtydspns if str=="1MG"
replace claim_mgs = 2*qtydspns if str=="2MG"
replace claim_mgs = 4*qtydspns if str=="4MG"
replace claim_mgs = 1*qtydspns if str=="1 MG"
replace claim_mgs = 2*qtydspns if str=="2 MG"
...
gen tolte_dmg_2006 = itot_mgs/tolte_fdays_2006
...
forvalues d = 1/365{
	replace snf_push = snf_push + 1 if tolte_a`d'==1 & snf_a`d'==1

	//if the tolte_a`d' is 1, do nothing (already added it to the snf_push)
	//if that tolte_a spot is empty:
	gen v1 = 1 if snf_push>0 & tolte_a`d'==.
	replace tolte_a`d' = 1 if v1==1
...
forvalues d = 1/365{
	replace ips_push = ips_push + 1 if tolte_a`d'==1 & ips_a`d'==1

	//if the tolte_a`d' is 1, do nothing (already added it to the ips_push)
	//if that tolte_a spot is not full:
	gen v1 = 1 if ips_push>0 & tolte_a`d'==.
	replace tolte_a`d' = 1 if v1==1
...
*/
forvalues d = 1/365{
	replace tolte_pdays_2006 = tolte_pdays_2006 + 1 if tolte_a`d'==1
}
drop tolte_a*
replace tolte_pdays_2006 = 365 if tolte_pdays_2006>365

//	mgs in year, for all the possession days
gen tolte_totmg_2006 = tolte_pdays_2006*tolte_dmg_2006
//	total daily doses in the year
gen tolte_totdd_2006 = tolte_totmg_2006/2
...
egen tolte_push_2006 = rowmax(lastfill_push inyear_push) 
replace tolte_push_2006 = 0 if tolte_push_2006==.
replace tolte_push_2006 = 0 if tolte_push_2006<0
...
replace pushstock = pushstock + tolte_push_2006 if bene_id!=bene_id[_n-1] | _n==1
...
/////////////////bene-class timing
egen tolte_fdays_2007 = sum(dayssply), by(idn)
egen tolte_clms_2007 = count(dayssply), by(idn)
egen tolte_minfilldt_2007 = min(srvc_dt), by(idn)
egen tolte_maxfilldt_2007 = max(srvc_dt), by(idn)
gen tolte_fillperiod_2007 = tolte_maxfilldt_2007 - tolte_minfilldt_2007 + 1
...
egen itot_mgs = sum(claim_mgs), by(idn)
//average mgs per day supplied
gen tolte_dmg_2007 = itot_mgs/tolte_fdays_2007
drop claim_mgs itot_mgs
...
*/
forvalues d = 1/365{
	replace tolte_pdays_2007 = tolte_pdays_2007 + 1 if tolte_a`d'==1
}
drop tolte_a*
replace tolte_pdays_2007 = 365 if tolte_pdays_2007>365

//	mgs in year, for all the possession days
gen tolte_totmg_2007 = tolte_pdays_2007*tolte_dmg_2007
//	total daily doses in the year
gen tolte_totdd_2007 = tolte_totmg_2007/2
...
gen inyear_push = earlyfill_push + snf_push + ips_push
replace inyear_push = 30 if inyear_push>30 & inyear_push!=.
egen tolte_push_2007 = rowmax(lastfill_push inyear_push) 
replace tolte_push_2007 = 0 if tolte_push_2007==.
replace tolte_push_2007 = 0 if tolte_push_2007<0
...
//add the pushstock from last year
replace pushstock = pushstock + tolte_push_2007 if bene_id!=bene_id[_n-1] | _n==1
...
/////////////////bene-class timing
egen tolte_fdays_2008 = sum(dayssply), by(idn)
egen tolte_clms_2008 = count(dayssply), by(idn)
egen tolte_minfilldt_2008 = min(srvc_dt), by(idn)
egen tolte_maxfilldt_2008 = max(srvc_dt), by(idn)
gen tolte_fillperiod_2008 = tolte_maxfilldt_2008 - tolte_minfilldt_2008 + 1
...
egen itot_mgs = sum(claim_mgs), by(idn)
//average mgs per day supplied
gen tolte_dmg_2008 = itot_mgs/tolte_fdays_2008
drop claim_mgs itot_mgs
...
*/
forvalues d = 1/365{
	replace tolte_pdays_2008 = tolte_pdays_2008 + 1 if tolte_a`d'==1
}
drop tolte_a*
replace tolte_pdays_2008 = 365 if tolte_pdays_2008>365

//	mgs in year, for all the possession days
gen tolte_totmg_2008 = tolte_pdays_2008*tolte_dmg_2008
//	total daily doses in the year
gen tolte_totdd_2008 = tolte_totmg_2008/2
...
gen inyear_push = earlyfill_push + snf_push + ips_push
replace inyear_push = 30 if inyear_push>30 & inyear_push!=.
egen tolte_push_2008 = rowmax(lastfill_push inyear_push) 
replace tolte_push_2008 = 0 if tolte_push_2008==.
replace tolte_push_2008 = 0 if tolte_push_2008<0
...
//add the pushstock from last year
replace pushstock = pushstock + tolte_push_2008 if bene_id!=bene_id[_n-1] | _n==1
...
/////////////////bene-class timing
egen tolte_fdays_2009 = sum(dayssply), by(idn)
egen tolte_clms_2009 = count(dayssply), by(idn)
egen tolte_minfilldt_2009 = min(srvc_dt), by(idn)
egen tolte_maxfilldt_2009 = max(srvc_dt), by(idn)
gen tolte_fillperiod_2009 = tolte_maxfilldt_2009 - tolte_minfilldt_2009 + 1
...
egen itot_mgs = sum(claim_mgs), by(idn)
//average mgs per day supplied
gen tolte_dmg_2009 = itot_mgs/tolte_fdays_2009
drop claim_mgs itot_mgs
...
*/
forvalues d = 1/365{
	replace tolte_pdays_2009 = tolte_pdays_2009 + 1 if tolte_a`d'==1
}
drop tolte_a*
replace tolte_pdays_2009 = 365 if tolte_pdays_2009>365

//	mgs in year, for all the possession days
gen tolte_totmg_2009 = tolte_pdays_2009*tolte_dmg_2009
//	total daily doses in the year
gen tolte_totdd_2009 = tolte_totmg_2009/2
...
gen inyear_push = earlyfill_push + snf_push + ips_push
replace inyear_push = 30 if inyear_push>30 & inyear_push!=.
egen tolte_push_2009 = rowmax(lastfill_push inyear_push) 
replace tolte_push_2009 = 0 if tolte_push_2009==.
replace tolte_push_2009 = 0 if tolte_push_2009<0
...
//add the pushstock from last year
replace pushstock = pushstock + tolte_push_2009 if bene_id!=bene_id[_n-1] | _n==1
...
/////////////////bene-class timing
egen tolte_fdays_2010 = sum(dayssply), by(idn)
egen tolte_clms_2010 = count(dayssply), by(idn)
egen tolte_minfilldt_2010 = min(srvc_dt), by(idn)
egen tolte_maxfilldt_2010 = max(srvc_dt), by(idn)
gen tolte_fillperiod_2010 = tolte_maxfilldt_2010 - tolte_minfilldt_2010 + 1
...
egen itot_mgs = sum(claim_mgs), by(idn)
//average mgs per day supplied
gen tolte_dmg_2010 = itot_mgs/tolte_fdays_2010
drop claim_mgs itot_mgs
...
*/
forvalues d = 1/365{
	replace tolte_pdays_2010 = tolte_pdays_2010 + 1 if tolte_a`d'==1
}
drop tolte_a*
replace tolte_pdays_2010 = 365 if tolte_pdays_2010>365

//	mgs in year, for all the possession days
gen tolte_totmg_2010 = tolte_pdays_2010*tolte_dmg_2010
//	total daily doses in the year
gen tolte_totdd_2010 = tolte_totmg_2010/2
...
gen inyear_push = earlyfill_push + snf_push + ips_push
replace inyear_push = 30 if inyear_push>30 & inyear_push!=.
egen tolte_push_2010 = rowmax(lastfill_push inyear_push) 
replace tolte_push_2010 = 0 if tolte_push_2010==.
replace tolte_push_2010 = 0 if tolte_push_2010<0
...
//add the pushstock from last year
replace pushstock = pushstock + tolte_push_2010 if bene_id!=bene_id[_n-1] | _n==1
...
/////////////////bene-class timing
egen tolte_fdays_2011 = sum(dayssply), by(idn)
egen tolte_clms_2011 = count(dayssply), by(idn)
egen tolte_minfilldt_2011 = min(srvc_dt), by(idn)
egen tolte_maxfilldt_2011 = max(srvc_dt), by(idn)
gen tolte_fillperiod_2011 = tolte_maxfilldt_2011 - tolte_minfilldt_2011 + 1
...
egen itot_mgs = sum(claim_mgs), by(idn)
//average mgs per day supplied
gen tolte_dmg_2011 = itot_mgs/tolte_fdays_2011
drop claim_mgs itot_mgs
...
*/
forvalues d = 1/365{
	replace tolte_pdays_2011 = tolte_pdays_2011 + 1 if tolte_a`d'==1
}
drop tolte_a*
replace tolte_pdays_2011 = 365 if tolte_pdays_2011>365

//	mgs in year, for all the possession days
gen tolte_totmg_2011 = tolte_pdays_2011*tolte_dmg_2011
//	total daily doses in the year
gen tolte_totdd_2011 = tolte_totmg_2011/2
...
gen inyear_push = earlyfill_push + snf_push + ips_push
replace inyear_push = 30 if inyear_push>30 & inyear_push!=.
egen tolte_push_2011 = rowmax(lastfill_push inyear_push) 
replace tolte_push_2011 = 0 if tolte_push_2011==.
replace tolte_push_2011 = 0 if tolte_push_2011<0
...
//add the pushstock from last year
replace pushstock = pushstock + tolte_push_2011 if bene_id!=bene_id[_n-1] | _n==1
...
/////////////////bene-class timing
egen tolte_fdays_2012 = sum(dayssply), by(idn)
egen tolte_clms_2012 = count(dayssply), by(idn)
egen tolte_minfilldt_2012 = min(srvc_dt), by(idn)
egen tolte_maxfilldt_2012 = max(srvc_dt), by(idn)
gen tolte_fillperiod_2012 = tolte_maxfilldt_2012 - tolte_minfilldt_2012 + 1
...
egen itot_mgs = sum(claim_mgs), by(idn)
//average mgs per day supplied
gen tolte_dmg_2012 = itot_mgs/tolte_fdays_2012
drop claim_mgs itot_mgs
...
*/
forvalues d = 1/365{
	replace tolte_pdays_2012 = tolte_pdays_2012 + 1 if tolte_a`d'==1
}
drop tolte_a*
replace tolte_pdays_2012 = 365 if tolte_pdays_2012>365

//	mgs in year, for all the possession days
gen tolte_totmg_2012 = tolte_pdays_2012*tolte_dmg_2012
//	total daily doses in the year
gen tolte_totdd_2012 = tolte_totmg_2012/2
...
gen inyear_push = earlyfill_push + snf_push + ips_push
replace inyear_push = 30 if inyear_push>30 & inyear_push!=.
egen tolte_push_2012 = rowmax(lastfill_push inyear_push) 
replace tolte_push_2012 = 0 if tolte_push_2012==.
replace tolte_push_2012 = 0 if tolte_push_2012<0
...
//add the pushstock from last year
replace pushstock = pushstock + tolte_push_2012 if bene_id!=bene_id[_n-1] | _n==1
...
/////////////////bene-class timing
egen tolte_fdays_2013 = sum(dayssply), by(idn)
egen tolte_clms_2013 = count(dayssply), by(idn)
egen tolte_minfilldt_2013 = min(srvc_dt), by(idn)
egen tolte_maxfilldt_2013 = max(srvc_dt), by(idn)
gen tolte_fillperiod_2013 = tolte_maxfilldt_2013 - tolte_minfilldt_2013 + 1
...
egen itot_mgs = sum(claim_mgs), by(idn)
//average mgs per day supplied
gen tolte_dmg_2013 = itot_mgs/tolte_fdays_2013
drop claim_mgs itot_mgs
...
*/
forvalues d = 1/365{
	replace tolte_pdays_2013 = tolte_pdays_2013 + 1 if tolte_a`d'==1
}
drop tolte_a*
replace tolte_pdays_2013 = 365 if tolte_pdays_2013>365

//	mgs in year, for all the possession days
gen tolte_totmg_2013 = tolte_pdays_2013*tolte_dmg_2013
//	total daily doses in the year
gen tolte_totdd_2013 = tolte_totmg_2013/2
...
gen inyear_push = earlyfill_push + snf_push + ips_push
replace inyear_push = 30 if inyear_push>30 & inyear_push!=.
egen tolte_push_2013 = rowmax(lastfill_push inyear_push) 
replace tolte_push_2013 = 0 if tolte_push_2013==.
replace tolte_push_2013 = 0 if tolte_push_2013<0
...
//add the pushstock from last year
replace pushstock = pushstock + tolte_push_2013 if bene_id!=bene_id[_n-1] | _n==1
...
/////////////////bene-class timing
egen tolte_fdays_2014 = sum(dayssply), by(idn)
egen tolte_clms_2014 = count(dayssply), by(idn)
egen tolte_minfilldt_2014 = min(srvc_dt), by(idn)
egen tolte_maxfilldt_2014 = max(srvc_dt), by(idn)
gen tolte_fillperiod_2014 = tolte_maxfilldt_2014 - tolte_minfilldt_2014 + 1
...
egen itot_mgs = sum(claim_mgs), by(idn)
//average mgs per day supplied
gen tolte_dmg_2014 = itot_mgs/tolte_fdays_2014
drop claim_mgs itot_mgs
...
*/
forvalues d = 1/365{
	replace tolte_pdays_2014 = tolte_pdays_2014 + 1 if tolte_a`d'==1
}
drop tolte_a*
replace tolte_pdays_2014 = 365 if tolte_pdays_2014>365

//	mgs in year, for all the possession days
gen tolte_totmg_2014 = tolte_pdays_2014*tolte_dmg_2014
//	total daily doses in the year
gen tolte_totdd_2014 = tolte_totmg_2014/2
...
gen inyear_push = earlyfill_push + snf_push + ips_push
replace inyear_push = 30 if inyear_push>30 & inyear_push!=.
egen tolte_push_2014 = rowmax(lastfill_push inyear_push) 
replace tolte_push_2014 = 0 if tolte_push_2014==.
replace tolte_push_2014 = 0 if tolte_push_2014<0
